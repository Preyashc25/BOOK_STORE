        ...
        <div>
          ...
          {ratingAvg > 0 && (
            <div className="flex items-center gap-1.5 mt-3 font-sans text-sm text-ink/70">
              ...
              <span>
                {ratingAvg.toFixed(1)} ({numReviews} review{numReviews === 1 ? '' : 's'})
              </span>
            </div>
          )}

          <div className="flex items-center gap-3 mt-6">
            <p className="font-display text-2xl text-leather">{formatPrice(finalPrice)}</p>
            {discountPercent > 0 && (
              <>
          ...
          <div className="mt-8 flex items-center gap-4">
            ...
            >
              {inStock ? (added ? 'Added ✓' : 'Add to shelf') : 'Out of stock'}
            </button>
          </div>
